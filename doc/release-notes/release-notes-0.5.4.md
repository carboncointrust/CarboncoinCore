Carboncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/carboncoin/files/Carboncoin/carboncoin-0.5.4/
...
http://gitorious.org/carboncoin/carboncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Carboncoin-Qt notifications under Growl 1.3.
Increase required age of Carboncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCarboncoin properly when installing Carboncoin-Qt over it. (Windows)
