Carboncoin Core version 0.9.2.1 is now available from:

  https://carboncoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CARBON to 0.01 CARBON
...
- Fix "Start carboncoin on system login"
