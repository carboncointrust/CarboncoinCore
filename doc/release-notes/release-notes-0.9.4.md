Carboncoin Core version 0.9.4 is now available from:

  https://carboncoin.org/bin/0.9.4/
...
this update is incompatible with the Carboncoin system and could lead to consensus
forks.

Carboncoin Core released binaries from https://carboncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~carboncoin/+archive/ubuntu/carboncoin
- A third-party or self-compiled Carboncoin Core

upgrade to Carboncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
