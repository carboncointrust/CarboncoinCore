...
in the carboncoin repository under 'Fetch and build inputs' to install sources which require
...
To build Carboncoin (for Linux, OS X and Windows) just follow the steps under 'perform
...
CARBONPATH=/some/root/path/carboncoin.git
SIGPATH=/some/root/path/carboncoin-detached-sigs.git
...
[carboncoin/gitian.sigs](https://github.com/carboncoin/gitian.sigs/) repository, or if that's not possible create a pull
