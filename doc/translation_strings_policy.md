...
This document provides guidelines for internationalization of the Carboncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `carboncoin_en.ts` remains unchanged.
