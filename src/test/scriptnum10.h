...
#ifndef CARBONCOIN_TEST_SCRIPTNUM10_H
#define CARBONCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Carboncoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CARBONCOIN_TEST_BIGNUM_H
