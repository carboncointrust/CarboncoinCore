...
#ifndef _CARBONCOINRPC_CLIENT_H_
#define _CARBONCOINRPC_CLIENT_H_ 1
...
/** Show help message for carboncoin-cli.
 ...
 *
 * @note the argument can be removed once carboncoin-cli functionality is removed from carboncoind
 */
