...
void Shutdown()
{
    ...
    if (pwalletMain)
        bitdb.Flush(false);
    GenerateCarboncoins(false, NULL, 0);
#endif
    StopNode();
...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "\n" + _("RPC SSL options: (see the Carboncoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (pwalletMain)
        GenerateCarboncoins(GetBoolArg("-gen", false), pwalletMain, GetArg("-genproclimit", -1));
#endif
