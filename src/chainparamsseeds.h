#ifndef CARBONCOIN_CHAINPARAMSSEEDS_H
#define CARBONCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the carboncoin network
...
#endif // CARBONCOIN_CHAINPARAMSSEEDS_H
