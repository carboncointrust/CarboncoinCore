...
<context>
    ...
    <message>
        ...
        <translation>Повідомлення, що було додане до carboncoin:URI та буде збережено разом з транзакцією для довідки. Примітка: Це повідомлення не буде відправлено в мережу Bitcoin.</translation>
    </message>
    <message>
