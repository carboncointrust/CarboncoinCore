...
// Copyright (c) 2009-2012 The Carboncoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Carboncoin/$1-%s The Carboncoin/' %s"
REGEX_CURRENT= re.compile("%s The Carboncoin" % year)
