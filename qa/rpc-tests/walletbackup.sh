...
B4ARGS="-datadir=$D4"
$CARBONCOIND $CARBONCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$CARBONCOIND $CARBONCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $CARBONCOIND $CARBONCOINDARGS $B1ARGS &
  B1PID=$!
  $CARBONCOIND $CARBONCOINDARGS $B2ARGS &
  B2PID=$!
  $CARBONCOIND $CARBONCOINDARGS $B3ARGS &
  B3PID=$!
}
